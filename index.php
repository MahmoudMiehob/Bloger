                   ...
                   @ $res = mysqli_query($conn,$query) ;
                    ...
                    <div class="post">
                        ...
                        <div class="post-details">
                            ...
                            <p class="postContent">
                            <?php
                                if(strlen($row['post_conntent']) > 150){
                                    $row['post_conntent'] = substr($row['post_conntent'] , 0 , 300) . "...." ;
                                }
                                echo $row['post_conntent'];
                            ?>
                            </p>
                            <a href="post.php?id=<?php echo $row['id'] ?>"> <button class="btn btn-custom">قراءة المزيد</button></a>
                        </div>
                    </div>
                  <?php  } ?>
                </div>
